...
use App\Models\mob_notifications;
...
class DashboardInit
{
    ...
    public function __construct()
    {
        $this->panelItems = array(
            ...
            "wel_office" => array(
                "title" => "wel_office", "icon" => "mdi mdi-book-multiple",
                "children" => array(
            ...
            "staticContent" => array(
                "title" => "staticPages", "icon" => "mdi mdi-book-multiple", "activated" => "staticpagesAct",
                "children" => array(
            ...
            "attendance" => array(
                "title" => "Attendance", "icon" => "mdi mdi-check-all", "activated" => "attendanceAct",
                "children" => array(
            ...
            "staffAttendance" => array(
                "title" => "staffAttendance", "icon" => "mdi mdi-check", "activated" => "staffAttendanceAct",
                "children" => array(
            ...
            "vacation" => array(
                "title" => "Vacation", "icon" => "mdi mdi-airplane", "activated" => "vacationAct",
                "children" => array(
            ...
            "library" => array(
                "title" => "Library", "icon" => "mdi mdi-library", "activated" => "bookslibraryAct",
                "children" => array(
            ...
            "employees" => array(
                "title" => "employees", "icon" => "mdi mdi-briefcase", "activated" => "employeesAct",
                "children" => array(
            ...
            "students" => array(
                "title" => "students", "icon" => "mdi mdi-account-multiple-outline",
                "children" => array(
            ...
            "payroll" => array(
                "title" => "Payroll", "icon" => "mdi mdi-bank", "activated" => "payrollAct",
                "children" => array(
            ...
            "accounting" => array(
                "title" => "accounting", "icon" => "mdi mdi-currency-usd", "activated" => "paymentsAct",
                "children" => array(
            ...
            "expensesList" => array(
                "title" => "Expenses", "icon" => "mdi mdi-currency-usd", "activated" => "expensesAct",
                "children" => array(
            ...
            "incomeList" => array(
                "title" => "Incomes", "icon" => "fa fa-money", "activated" => "incomeAct",
                "children" => array(
            ...
            "inventory" => array(
                "title" => "inventory", "icon" => "mdi mdi-sitemap", "activated" => "inventoryAct",
                "children" => array(
            ...
            "classes" => array(
                "title" => "classes", "icon" => "mdi mdi-sitemap",
                "children" => array(
            ...
            "hostel" => array(
                "title" => "HostelManage", "icon" => "mdi mdi-home-map-marker", "activated" => "hostelAct",
                "children" => array(
            ...
            "Transportation" => array(
                "title" => "Transportation", "icon" => "mdi mdi-bus", "activated" => "transportAct",
                "children" => array(
            ...
            "frontEnd" => array(
                "title" => "frontendCMS", "icon" => "mdi mdi-book-multiple",
                "children" => array(
            ...
            "adminTasks" => array(
                "title" => "adminTasks", "icon" => "mdi mdi-settings",
                "children" => array(
    ...
    //     }
        ...
        $this->weekdays = array(
            "ethiopic" => array(1 => 'እሑድ', 2 => 'ሰኞ', 3 => 'ማክሰኞ', 4 => 'ረቡዕ', 5 => 'ሓሙስ', 6 => 'ዓርብ', 7 => 'ቅዳሜ'),
    ...
    public function validate_upload($file)
    {
        $allowed_mime_type = array(
            "text/plain", "text/html", "text/css", "text/javascript", "text/markdown", "text/pdf", "text/richtext", "text/calendar",
    ...
    public function hasThePerm($perm)
    {
        ...
        and Auth::user()->customPermissionsType == "custom"
        and is_array(Auth::user()->customPermissionsAsJson())
         and !in_array($perm, Auth::user()->customPermissionsAsJson())) {
            return false;
        } else {
            return true;
        }
